...
class Settings:
    ...
    # M12 - Vector Candidate 검색 질의(Query) 문장의 최대 문자 수(요청 본문 자체가
    # 이미 작으므로 Multipart Envelope 상한과는 별개의 작은 상한이다).
...
def get_settings() -> Settings:
    return Settings(
        ...
        max_query_chars=_int_env("SDV_QUERY_MAX_CHARS", Settings.max_query_chars),
