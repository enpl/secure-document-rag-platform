...
function App() {
  ...
  return (
    <>
      <SessionBootstrap key={subject} subject={subject as string} />
      <Routes>
        <Route
          path="/"
          element={
        ...
        <Route
          ...
          element={
            isAdmin ? (
              <AppShell title="사용자 접근">
                <UserAccessAdminPage key={subject} />
              </AppShell>
            ) : (
              <Navigate to="/" replace />
            )
        ...
        <Route
          ...
          element={
            isAdmin ? (
              <AppShell title="보안 발견">
                <SecurityDashboardPage key={subject} />
              </AppShell>
            ) : (
              <Navigate to="/" replace />
            )
